...
openFB = (function () {
    ...
    // Default OAuth redirect URL. Can be overriden in init()
		...
		oauthRedirectURL = app.https + 'kcals.net/oauthcallback.html',
    ...
    // Default Logout redirect URL. Can be overriden in init()
		...
		logoutRedirectURL = app.https + 'kcals.net/logoutcallback.html',
