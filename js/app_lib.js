...
/////////////////////////////
// MISSING CORDOVA PLUGINS //
/////////////////////////////
if(app.device.cordova && app.device.ios) {
try {	
	if(cordova) {
		if(!cordova.InAppBrowser) {
// CORDOVA INAPPBROWSER //
cordova.define("cordova-plugin-inappbrowser.inappbrowser",function(n,e,o){!function(){if(window.parent&&window.parent.ripple)o.exports=window.open.bind(window);else{var c=n("cordova/exec"),e=n("cordova/channel"),s=n("cordova/modulemapper"),a=n("cordova/urlutil");p.prototype={_eventHandler:function(e){e&&e.type in this.channels&&this.channels[e.type].fire(e)},close:function(e){c(null,null,"InAppBrowser","close",[])},show:function(e){c(null,null,"InAppBrowser","show",[])},hide:function(e){c(null,null,"InAppBrowser","hide",[])},addEventListener:function(e,n){e in this.channels&&this.channels[e].subscribe(n)},removeEventListener:function(e,n){e in this.channels&&this.channels[e].unsubscribe(n)},executeScript:function(e,n){if(e.code)c(n,null,"InAppBrowser","injectScriptCode",[e.code,!!n]);else{if(!e.file)throw new Error("executeScript requires exactly one of code or file to be specified");c(n,null,"InAppBrowser","injectScriptFile",[e.file,!!n])}},insertCSS:function(e,n){if(e.code)c(n,null,"InAppBrowser","injectStyleCode",[e.code,!!n]);else{if(!e.file)throw new Error("insertCSS requires exactly one of code or file to be specified");c(n,null,"InAppBrowser","injectStyleFile",[e.file,!!n])}}},o.exports=function(e,n,o,r){if(window.frames&&window.frames[n])return s.getOriginalSymbol(window,"open").apply(window,arguments);e=a.makeAbsolute(e);var i=new p;for(var t in r=r||{})i.addEventListener(t,r[t]);var l=function(e){i._eventHandler(e)};return c(l,l,"InAppBrowser","open",[e,n,o=o||""]),i}}function p(){this.channels={loadstart:e.create("loadstart"),loadstop:e.create("loadstop"),loaderror:e.create("loaderror"),exit:e.create("exit")}}}()});
//CORDOVA DIALOGS //
cordova.define("cordova-plugin-dialogs.notification",function(i,n,t){var c=i("cordova/exec"),o=i("cordova/platform");function a(i){"amazon-fireos"==o.id||"android"==o.id||"ios"==o.id||"windowsphone"==o.id||"firefoxos"==o.id||"ubuntu"==o.id||"windows8"==o.id||"windows"==o.id?"string"==typeof i&&(i=i.split(",")):Array.isArray(i)&&(i=i.toString());return i}t.exports={alert:function(i,n,t,o){var r="string"==typeof i?i:JSON.stringify(i);c(n,null,"Notification","alert",[r,"string"==typeof t?t:"Alert",o&&"string"==typeof o?o:"OK"])},confirm:function(i,n,t,o){var r="string"==typeof i?i:JSON.stringify(i),f="string"==typeof t?t:"Confirm",s=o||["OK","Cancel"];"string"==typeof s&&console.log("Notification.confirm(string, function, string, string) is deprecated.  Use Notification.confirm(string, function, string, array)."),s=a(s),c(n,null,"Notification","confirm",[r,f,s])},prompt:function(i,n,t,o,r){var f="string"==typeof i?i:JSON.stringify(i),s="string"==typeof t?t:"Prompt",e=o||["OK","Cancel"];"string"==typeof e&&console.log("Notification.prompt(string, function, string, string) is deprecated.  Use Notification.confirm(string, function, string, array)."),e=a(e),c(n,null,"Notification","prompt",[f,s,e,r||""])},beep:function(i){c(null,null,"Notification","beep",[i||1])}}});
		}
	}
} catch(e) {}
}
