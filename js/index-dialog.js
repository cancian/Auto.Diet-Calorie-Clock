...
//#/////////////////#// taphold doubleTap singleTap swipe
	...
	$("#configNow").on("hold", function(evt) {
		...
		//	onConfirmWipe(1);
		$.Zebra_Dialog('', {'type':'','title':LANG("WIPE_DIALOG") + "?",'buttons': [{caption: LANG("OK"), callback: function() { onConfirmWipe(1); }},{caption: LANG("CANCEL")}] });
	//}
	});
	//TAP
	$("#configNow").on('singleTap', function(evt) {
		...
		//	onConfirmReset(1);
		$.Zebra_Dialog('', {'type':'','title':LANG("RESET_DIALOG") + "?",'buttons': [{caption: LANG("OK"), callback: function() { onConfirmWipe(1); }},{caption: LANG("CANCEL")}] });
		//}
	});
	////////////////////
	// RESET FUNCTION //
