...
//    if ($("#automatic_recalc.checked || ctl == '') {
        ...
        co.pA6N = $("#pA6N").val();
/*
       co.pA1B = window.localStorage.getItem("calcForm#pA1B"); //$("#pA1B[$("#pA1B.selectedIndex].value;
       co.pA2B = window.localStorage.getItem("calcForm#pA2B"); //eeparseFloat($("#pA2B.value);
       co.pA2C = window.localStorage.getItem("calcForm#pA2C"); //$("#pA2C[$("#pA2C.selectedIndex].value;
       co.pA3B = window.localStorage.getItem("calcForm#pA3B"); //eeparseFloat($("#pA3B.value);
       co.pA3C = window.localStorage.getItem("calcForm#pA3C"); //$("#pA3C[$("#pA3C.selectedIndex].value;
       co.pA4B = window.localStorage.getItem("calcForm#pA4B"); //eeparseFloatV($("#pA4B[$("#pA4B.selectedIndex].value);
       co.pA5B = window.localStorage.getItem("calcForm#pA5B"); //$("#pA5B[$("#pA5B.selectedIndex].value;
       co.pA6G = window.localStorage.getItem("calcForm#pA6G"); //eeparseFloat($("#pA6G.value);
       co.pA6H = window.localStorage.getItem("calcForm#pA6H"); //$("#pA6H[$("#pA6H.selectedIndex].value;
       co.pA6M = window.localStorage.getItem("calcForm#pA6M"); //eeparseFloat($("#pA6M.value);
       co.pA6N = window.localStorage.getItem("calcForm#pA6N"); //$("#pA6N[$("#pA6N.selectedIndex].value;
*/
        calc(co);
