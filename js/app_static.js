...
if(app.device.osxapp) {
	...
	/////////////////// (RESET SETTINGS)
	try {
		if(macgap.menu.getItem('Scientific Diet Clock').submenu().getItem(LANG.SETTINGS_WIPE[lang])) {
			macgap.menu.getItem('Scientific Diet Clock').submenu().getItem(LANG.SETTINGS_WIPE[lang]).remove();
		}
		macgap.menu.getItem('Scientific Diet Clock').submenu().addSeparator();
		macgap.menu.getItem('Scientific Diet Clock').submenu().addItem(LANG.SETTINGS_WIPE[lang], 'cmd+opt+r', function() {
