...
InAppPurchaseManager.prototype.makePurchase = function(productId, quantity, successCallback, failCallback) {
	...
	}, function (productId) { failCallback(); }, 'InAppPurchaseManager', 'makePurchase', [productId, q]);
}
...
InAppPurchaseManager.prototype.restoreCompletedTransactions = function(successCallback, failCallback) {
    return cordova.exec(
	//function (productId) { window.plugins.inAppPurchaseManager.onRestored("", productId, "");}
	function (productId) { successCallback(); },
	function (productId) { failCallback(); },
