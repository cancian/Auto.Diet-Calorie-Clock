...
if(document.URL.indexOf( 'http://' ) === -1 && document.URL.indexOf( 'https://' ) === -1 && navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|IEMobile)/)) {
	...
	document.write("<script type='text/javascript' src='js/facebook-js-sdk.min.js?"+newDate+"'><\/script>");
}
//JS
//document.write("<script type='text/javascript' src='js/jquery-2.1.0.min.js?"+newDate+"'><\/script>");
