...
var baseVersion  = 1.9;
var JScompress   = true;
var JSdev        = window.localStorage.getItem('config_debug') == 'active' ? '' : 'min/';
...
function initJS() {
	...
	if (!/http/i.test(window.location.protocol) && (/(iPhone|iPod|iPad|Android)/).test(navigator.userAgent)) {
		...
		document.write('<script type="text/javascript" src="' + hostLocal + 'js/' + JSdev + 'facebook-js-sdk.min.js" async="async"><\/script>');
	}
	////////
	// JS //
	////////
