...
app.tab.settings = function(keepOpen) {
	...
	*/
	...
	app.handlers.activeRow('#liveZilla','activeRow',function(evt) {
		getNewWindow('Online Support','<iframe id="liveZillaIframe" src="' + httpx + 'chronoburn.com/livezilla7/chat.php?a=fd1e5&amp;el=ZW4_" scrolling="no" width="100%" height="'+($('#appContent').height()-44)+'" style="width: 100%; position: absolute; top: 0; left: 0; right: 0; bottom: 0; display: block; background-color: #fff; border: 0; overflow: hidden !important;"></iframe>',function() {
