...
var LANG = {
	...
	SWIPE_TOOLTIP : {
		...
		it : 'scorri il dito per iniziare',
		ja : '開始するにはスワイプ',
		ko : '밀어서 시작하기',
	...
	STATUS_EQ_TIME_5 : {
		...
		it : 'Il vostro prossimo pasto dovrebbe avere intorno ',
		ja : '次の食事で必要なのは ',
		ko : '다음 식사는 ',
	...
	STATUS_LOSS_2 : {
		...
		it : '(Sulla base di una restrizione calorica di ',
		ja : '（カロリー制限に基づいて ',
		ko : '(칼로리 제한에 기초 ',
	...
	STATUS_INTAKE_1 : {
		...
		it : 'Il tuo apporto calorico quotidiano dovrebbe essere uguale (',
		ja : '適切な毎日のカロリー摂取量は （',
		ko : '1일 칼로리 섭취는 (',
	...
	STATUS_INTAKE_2 : {
		...
		it : ') + (Calorie bruciate da esercizio fisico)\n\nQuanto più ci si allena, più si può mangiare!',
	...
	SHARE_MESSAGE : {
		...
		it : 'Sto utilizzando MyLiveDiet per monitorare le calorie in tempo reale! Check it out!',
