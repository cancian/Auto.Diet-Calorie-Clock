if (!/http/i.test(window.location.protocol) && (/(iPhone|iPod|iPad|Android)/).test(navigator.userAgent)) {}
	...
	try {
		window.FB || (function (window) {
			...
			__d("ES", ["ES5ArrayPrototype", "ES5FunctionPrototype", "ES5StringPrototype", "ES5Array", "ES5Object", "ES5Date", "JSON3", "ES6Object", "ES6ArrayPrototype", "ES6DatePrototype", "ES6Number"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
				...
				function w(x, y, z) {
					...
					var da = z ? r.call(x).slice(8, -1) + '.prototype' : x,
					ea = s[da + '.' + y] || x[y];
			...
			__d("sdk.domReady", [], function (a, b, c, d, e, f) {
				var g,
				h = "readyState" in document ? /loaded|complete/.test(document.readyState) : !!document.body;
				function i() {
					if (!g)
						return;
					var l;
			...
			__d("ApiClient", ["ArgumentError", "Assert", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "sprintf", "sdk.URI", "UrlMap", "ApiClientConfig", "invariant"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
				...
				function ha() {
					...
					sa = pa.params,
					ta = sa.method,
					ua = qa.getProtocol() && qa.getDomain() ? qa.setQueryData({}).toString() : r.resolve('graph') + qa.getPath();
			...
			__d("sdk.UIServer", ["sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Frictionless", "Log", "sdk.Native", "QueryString", "sdk.RPC", "sdk.Runtime", "JSSDKConfig", "sdk.UA", "UrlMap", "sdk.XD", "createObjectFrom", "flattenObject", "sdk.getContextType", "guid", "insertIframe", "resolveURI"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa) {
				...
				da = {
					...
					prepareCall : function (ea, fa) {
						...
						ha = da.Methods.hasOwnProperty(ga) ? ES('Object', 'assign', false, {}, da.Methods[ga]) : {},
						ia = y(),
			...
			__d("IframePlugin", ["sdk.Auth", "sdk.DOM", "sdk.Event", "Log", "ObservableMixin", "sdk.PlatformVersioning", "PluginPipe", "QueryString", "sdk.Runtime", "Type", "sdk.UA", "sdk.URI", "UrlMap", "sdk.XD", "sdk.createIframe", "guid", "resolveURI"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
				...
				var fa = p.extend({
						constructor : function (ga, ha, ia, ja) {
							...
							ma = s.resolve('www', la) + '/plugins/' + ia + '.php?',
							na = {};
							...
							if (q.mobile())
								na.container_width = ga.offsetWidth;
							h.addCss(ga, 'fb_iframe_widget');
							if (this.isFluid())
								h.addCss(ga, 'fb_iframe_widget_fluid_desktop');
							var oa = v();
						...
						process : function () {
							...
							if (q.mobile()) {
								...
								if (!this._iframeOptions.width) {
									...
									if (q.iphone() || q.ipad())
										ES('Object', 'assign', false, ka, {
											width : '220px',
											'min-width' : '100%'
										});
									ES('Object', 'assign', false, this._iframe.style, ka);
								}
							}
						},
						getConfig : function () {
						...
						isFluid : function () {
							var ga = this.getConfig();
							return ga.fluid && !q.mobile();
						},
						reposition : function (ga) {
							var ha = h.getPosition(this._iframe).x,
							ia = h.getViewportInfo().width,
							ja = parseInt(h.getStyle(this._iframe, 'width'), 10),
							ka = {};
							if ((ha + ga) > ia && ha > ga) {
								this._iframe.style.left = parseInt(h.getStyle(this._iframe, 'width'), 10) - ga + 'px';
								this._isRepositioned = true;
								ka.type = 'reposition';
							} else if (this._isRepositioned && (ja - ga) !== 0) {
							...
							t.sendToFacebook(this._iframe.name, {
								...
								params : ES('JSON', 'stringify', false, ka)
							});
						},
						updateLift : function () {
			...
			__d("sdk.XFBML.IframeWidget", ["sdk.Arbiter", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Event", "sdk.XFBML.Element", "guid", "insertIframe", "QueryString", "sdk.Runtime", "sdk.ui", "UrlMap", "sdk.XD"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
				var t = l.extend({
						...
						_repositionIframe : function (x) {
							...
							aa = j.getPosition(y).x,
							ba = j.getViewportInfo().width,
		...
		new Image().src = "http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1563186","message":"' + e.message + '"}}');
	}
