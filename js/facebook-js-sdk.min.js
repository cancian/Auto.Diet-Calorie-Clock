/*1437174847,,JIT Construction: v1840672,en_US*/
...
__d("URISchemes",["createObjectFrom"],function(a,b,c,d,e,f,g){b.__markCompiled&&b.__markCompiled();var h=g(['fb','fb-ama','fb-messenger','fbcf','fbconnect','fbmobilehome','fbrpc','file','ftp','http','https','mailto','ms-app','intent','itms','itms-apps','itms-services','market','svn+ssh','fbstaging','tel','sms','pebblejs','sftp']),i={isAllowed:function(j){if(!j)return true;return h.hasOwnProperty(j.toLowerCase());}};e.exports=i;},null);
__d("URIBase",["URIRFC3986","URISchemes","ex","invariant"],function(a,b,c,d,e,f,g,h,i,j){b.__markCompiled&&b.__markCompiled();var k=new RegExp('[\\x00-\\x2c\\x2f\\x3b-\\x40\\x5c\\x5e\\x60\\x7b-\\x7f'+'\\uFDD0-\\uFDEF\\uFFF0-\\uFFFF'+'\\u2047\\u2048\\uFE56\\uFE5F\\uFF03\\uFF0F\\uFF1F]'),l=new RegExp('^(?:[^/]*:|'+'[\\x00-\\x1f]*/[\\x00-\\x1f]*/)');function m(p,q,r,s){if(!q)return true;if(q instanceof o){p.setProtocol(q.getProtocol());p.setDomain(q.getDomain());p.setPort(q.getPort());p.setPath(q.getPath());p.setQueryData(s.deserialize(s.serialize(q.getQueryData())));p.setFragment(q.getFragment());p.setForceFragmentSeparator(q.getForceFragmentSeparator());return true;}q=ES(q.toString(),'trim',true);var t=g.parse(q)||{};if(!r&&!h.isAllowed(t.scheme))return false;p.setProtocol(t.scheme||'');if(!r&&k.test(t.host))return false;p.setDomain(t.host||'');p.setPort(t.port||'');p.setPath(t.path||'');if(r){p.setQueryData(s.deserialize(t.query)||{});}else try{p.setQueryData(s.deserialize(t.query)||{});}catch(u){return false;}p.setFragment(t.fragment||'');if(t.fragment==='')p.setForceFragmentSeparator(true);if(t.userinfo!==null)if(r){throw new Error(i('URI.parse: invalid URI (userinfo is not allowed in a URI): %s',p.toString()));}else return false;if(!p.getDomain()&&ES(p.getPath(),'indexOf',true,'\\')!==-1)if(r){throw new Error(i('URI.parse: invalid URI (no domain but multiple back-slashes): %s',p.toString()));}else return false;if(!p.getProtocol()&&l.test(q))if(r){throw new Error(i('URI.parse: invalid URI (unsafe protocol-relative URLs): %s',p.toString()));}else return false;return true;}var n=[];function o(p,q){"use strict";j(q);this.$URIBase0=q;this.$URIBase1='';this.$URIBase2='';this.$URIBase3='';this.$URIBase4='';this.$URIBase5='';this.$URIBase6={};this.$URIBase7=false;m(this,p,true,q);}o.prototype.setProtocol=function(p){"use strict";j(h.isAllowed(p));this.$URIBase1=p;return this;};o.prototype.getProtocol=function(p){"use strict";return this.$URIBase1;};o.prototype.setSecure=function(p){"use strict";return this.setProtocol(p?'https':'http');};o.prototype.isSecure=function(){"use strict";return this.getProtocol()==='https';};o.prototype.setDomain=function(p){"use strict";if(k.test(p))throw new Error(i('URI.setDomain: unsafe domain specified: %s for url %s',p,this.toString()));this.$URIBase2=p;return this;};o.prototype.getDomain=function(){"use strict";return this.$URIBase2;};o.prototype.setPort=function(p){"use strict";this.$URIBase3=p;return this;};o.prototype.getPort=function(){"use strict";return this.$URIBase3;};o.prototype.setPath=function(p){"use strict";this.$URIBase4=p;return this;};o.prototype.getPath=function(){"use strict";return this.$URIBase4;};o.prototype.addQueryData=function(p,q){"use strict";if(Object.prototype.toString.call(p)==='[object Object]'){ES('Object','assign',false,this.$URIBase6,p);}else this.$URIBase6[p]=q;return this;};o.prototype.setQueryData=function(p){"use strict";this.$URIBase6=p;return this;};o.prototype.getQueryData=function(){"use strict";return this.$URIBase6;};o.prototype.removeQueryData=function(p){"use strict";if(!ES('Array','isArray',false,p))p=[p];for(var q=0,r=p.length;q<r;++q)delete this.$URIBase6[p[q]];return this;};o.prototype.setFragment=function(p){"use strict";this.$URIBase5=p;this.setForceFragmentSeparator(false);return this;};o.prototype.getFragment=function(){"use strict";return this.$URIBase5;};o.prototype.setForceFragmentSeparator=function(p){"use strict";this.$URIBase7=p;return this;};o.prototype.getForceFragmentSeparator=function(){"use strict";return this.$URIBase7;};o.prototype.isEmpty=function(){"use strict";return !(this.getPath()||this.getProtocol()||this.getDomain()||this.getPort()||ES('Object','keys',false,this.getQueryData()).length>0||this.getFragment());};o.prototype.toString=function(){"use strict";var p=this;for(var q=0;q<n.length;q++)p=n[q](p);return p.$URIBase8();};o.prototype.$URIBase8=function(){"use strict";var p='',q=this.getProtocol();if(q)p+=q+'://';var r=this.getDomain();if(r)p+=r;var s=this.getPort();if(s)p+=':'+s;var t=this.getPath();if(t){p+=t;}else if(p)p+='/';var u=this.$URIBase0.serialize(this.getQueryData());if(u)p+='?'+u;var v=this.getFragment();if(v){p+='#'+v;}else if(this.getForceFragmentSeparator())p+='#';return p;};o.registerFilter=function(p){"use strict";n.push(p);};o.prototype.getOrigin=function(){"use strict";var p=this.getPort();return this.getProtocol()+'://'+this.getDomain()+(p?':'+p:'');};o.isValidURI=function(p,q){return m(new o(null,q),p,false,q);};e.exports=o;},null);
...
__d("ApiClient",["ArgumentError","Assert","CORSRequest","FlashRequest","flattenObject","JSONPRequest","Log","ObservableMixin","QueryString","sprintf","sdk.URI","UrlMap","ApiClientConfig","invariant"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t){b.__markCompiled&&b.__markCompiled();var u,v,w,x=l.MAX_QUERYSTRING_LENGTH,y={get:true,post:true,'delete':true,put:true},z={fql_query:true,fql_multiquery:true,friends_get:true,notifications_get:true,stream_get:true,users_getinfo:true},aa=['jsonp','cors','flash'],ba=[],ca=[],da=null,ea=0,fa=[],ga=0,ha=50,ia=105440539523;function ja(sa,ta,ua,va){var wa=ga!==0&&ea>=ga;if(wa){fa.push(function(){return ja(sa,ta,ua,va);});qa.inform('request.queued',sa,ta,ua);return;}ea++;if(w)ua=ES('Object','assign',false,{},w,ua);ua.access_token=ua.access_token||u;ua.pretty=ua.pretty||0;ua=k(ua);var xa={jsonp:l,cors:i,flash:j},ya;if(ua.transport){ya=[ua.transport];delete ua.transport;}else ya=aa;for(var za=0;za<ya.length;za++){var ab=xa[ya[za]],bb=ES('Object','assign',false,{},ua);if(ab.execute(sa,ta,bb,va))return;}va({error:{type:'no-transport',message:'Could not find a usable transport for request'}});}function ka(sa,ta,ua,va,wa,xa){if(xa&&xa.error)qa.inform('request.error',ta,ua,va,xa,ES('Date','now',false)-wa);qa.inform('request.complete',ta,ua,va,xa,ES('Date','now',false)-wa);ea--;if(sa)sa(xa);var ya=fa.length>0&&ea<ga;if(ya){var za=fa.shift();za();}}function la(sa){var ta=sa.shift();h.isString(ta,'Invalid path');if(!/^https?/.test(ta)&&ta.charAt(0)!=='/')ta='/'+ta;var ua,va={};try{ua=new q(ta);}catch(wa){throw new g(wa.message,wa);}ES(sa,'forEach',true,function(ab){return va[typeof ab]=ab;});var xa=(va.string||'get').toLowerCase();h.isTrue(y.hasOwnProperty(xa),p('Invalid method passed to ApiClient: %s',xa));var ya=va['function'];if(!ya)m.warn('No callback passed to the ApiClient');if(va.object)ua.addQueryData(k(va.object));var za=ua.getQueryData();za.method=xa;return {uri:ua,callback:ya,params:za};}function ma(){for(var sa=[],ta=0,ua=arguments.length;ta<ua;ta++)sa.push(arguments[ta]);var va=la(sa),wa=va.uri,xa=va.callback,ya=va.params,za=ya.method;if(ra(wa,za))za='post';var ab=wa.getProtocol()&&wa.getDomain()?wa.setQueryData({}).toString():r.resolve('graph')+wa.getPath();qa.inform('request.prepare',ab,ya);ja(ab,za=='get'?'get':'post',ya,ES(ka,'bind',true,null,xa,wa.getPath(),za,ya,ES('Date','now',false)));}function na(){for(var sa=[],ta=0,ua=arguments.length;ta<ua;ta++)sa.push(arguments[ta]);var va=la(sa),wa=va.uri,xa=va.callback,ya=va.params,za=ya.method,ab={method:za,relative_url:wa.removeQueryData('method').toString()};if(za.toLowerCase()=='post'){ab.body=o.encode(wa.getQueryData());ab.relative_url=wa.setQueryData({}).toString();}ba.push(ab);ca.push(xa);if(ba.length==ha){if(da)clearTimeout(da);oa();}else if(!da)da=setTimeout(oa,0);}function oa(){t(ba.length>0);t(ba.length===ca.length);var sa=ba,ta=ca;ba=[];ca=[];da=null;if(sa.length===1){var ua=sa[0],va=ta[0],wa=ua.body?o.decode(ua.body):null;ma(ua.relative_url,ua.method,wa,va);return;}ma('/','POST',{batch:sa,include_headers:false,batch_app_id:v||ia},function(xa){if(ES('Array','isArray',false,xa)){ES(xa,'forEach',true,function(ya,za){ta[za](ES('JSON','parse',false,ya.body));});}else ES(ta,'forEach',true,function(ya){return ya({error:{message:'Fatal: batch call failed.'}});});});}function pa(sa,ta){h.isObject(sa);h.isString(sa.method,'method missing');if(!ta)m.warn('No callback passed to the ApiClient');var ua=sa.method.toLowerCase().replace('.','_');sa.format='json-strings';sa.api_key=v;var va=ua in z?'api_read':'api',wa=r.resolve(va)+'/restserver.php',xa=ES(ka,'bind',true,null,ta,'/restserver.php','get',sa,ES('Date','now',false));ja(wa,'get',sa,xa);}var qa=ES('Object','assign',false,new n(),{setAccessToken:function(sa){u=sa;},getAccessToken:function(){return u;},setClientID:function(sa){v=sa;},setDefaultParams:function(sa){w=sa;},setDefaultTransports:function(sa){aa=sa;},setMaxConcurrentRequests:function(sa){ga=sa;},getCurrentlyExecutingRequestCount:function(){return ea;},getQueuedRequestCount:function(){return fa.length;},rest:pa,graph:ma,scheduleBatchCall:na});function ra(sa,ta){return (sa.toString().length>x&&ta==='get');}j.setSwfUrl(s.FlashRequest.swfUrl);e.exports=qa;},null);
...
__d("legacy:fb.auth",["sdk.Auth","sdk.Cookie","sdk.Event","FB","Log","sdk.Runtime","sdk.SignedRequest","sdk.ui"],function(a,b,c,d,e,f,g,h,i,j,k,l,m,n){b.__markCompiled&&b.__markCompiled();j.provide('',{getLoginStatus:function(){return g.getLoginStatus.apply(g,arguments);},getAuthResponse:function(){return g.getAuthResponse();},getAccessToken:function(){return l.getAccessToken()||null;},getUserID:function(){return l.getUserID()||l.getCookieUserID();},login:function(o,p){if(p&&p.perms&&!p.scope){p.scope=p.perms;delete p.perms;k.warn('OAuth2 specification states that \'perms\' '+'should now be called \'scope\'.  Please update.');}var q=l.isEnvironment(l.ENVIRONMENTS.CANVAS)||l.isEnvironment(l.ENVIRONMENTS.PAGETAB);n(ES('Object','assign',false,{method:'permissions.oauth',display:q?'async':'popup',domain:location.hostname},(p||{})),o);},logout:function(o){n({method:'auth.logout',display:'hidden'},o);}});g.subscribe('logout',ES(i.fire,'bind',true,i,'auth.logout'));g.subscribe('login',ES(i.fire,'bind',true,i,'auth.login'));g.subscribe('authresponse.change',ES(i.fire,'bind',true,i,'auth.authResponseChange'));g.subscribe('status.change',ES(i.fire,'bind',true,i,'auth.statusChange'));i.subscribe('init:post',function(o){if(o.status)g.getLoginStatus();if(l.getClientID())if(o.authResponse){g.setAuthResponse(o.authResponse,'connected');}else if(l.getUseCookie()){var p=h.loadSignedRequest(),q;if(p){try{q=m.parse(p);}catch(r){h.clearSignedRequestCookie();}if(q&&q.user_id)l.setCookieUserID(q.user_id);}h.loadMeta();}});},3);
...
__d("legacy:fb.compat.ui",["FB","Log","sdk.ui","sdk.UIServer"],function(a,b,c,d,e,f,g,h,i,j){b.__markCompiled&&b.__markCompiled();g.provide('',{share:function(k){h.error('share() has been deprecated. Please use FB.ui() instead.');i({display:'popup',method:'stream.share',u:k});},publish:function(k,l){h.error('publish() has been deprecated. Please use FB.ui() instead.');k=k||{};i(ES('Object','assign',false,{display:'popup',method:'stream.publish',preview:1},(k||{})),l);},addFriend:function(k,l){h.error('addFriend() has been deprecated. Please use FB.ui() instead.');i({display:'popup',id:k,method:'friend.add'},l);}});j.Methods['auth.login']=j.Methods['permissions.request'];},3);
...
__d("sdk.XFBML.LoginButton",["sdk.Helper","IframePlugin","sdk.ui"],function(a,b,c,d,e,f,g,h,i){b.__markCompiled&&b.__markCompiled();var j=h.extend({constructor:function(k,l,m,n){this.parent(k,l,m,n);var o=h.getVal(n,'on_login');if(o)this.subscribe('login.status',function(p){g.invokeHandler(o,null,[p]);});this.subscribe('xd.login_button_native_open',function(p){i(ES('JSON','parse',false,p.params));});},getParams:function(){return {scope:'string',perms:'string',size:'string',login_text:'text',show_faces:'bool',max_rows:'string',show_login_face:'bool',registration_url:'url_maybe',auto_logout_link:'bool',one_click:'bool',show_banner:'bool',auth_type:'string',default_audience:'string'};}});e.exports=j;},null);
...
} catch (e) {new Image().src="http:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m='+encodeURIComponent('{"error":"LOAD", "extra": {"name":"'+e.name+'","line":"'+(e.lineNumber||e.line)+'","script":"'+(e.fileName||e.sourceURL||e.script)+'","stack":"'+(e.stackTrace||e.stack)+'","revision":"1840672","message":"'+e.message+'"}}');}